 ...
 * @author 33781
 */
public class infoenfant extends javax.swing.JFrame {
    ...
    public static void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(infoenfant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new infoenfant().setVisible(true);
            }
        });
    }
